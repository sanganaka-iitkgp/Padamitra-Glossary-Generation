...
wait_for_vram(target_gb=30, device=local_rank, check_interval=10)
...
training_args = SFTConfig(
    report_to="wandb",        
    run_name="phi4-glossary-1b-v1",

    output_dir="./phi4-glossary-1b",
...
trainer.save_model("./phi4-glossary-1b-best-model")
processor.save_pretrained("./phi4-glossary-1b-best-model")
