...
training_args = SFTConfig(
    report_to="wandb",        
    run_name="unsloth-gemma-3ne4b-it-glossary-1a-v2",

    output_dir="./unsloth-gemma-3ne4b-it-glossary-1a",
...
trainer.save_model("./unsloth-gemma-3ne4b-it-glossary-1a-best-model")
processor.save_pretrained("./unsloth-gemma-3ne4b-it-glossary-1a-best-model")
